      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12 relative">
        ...
        <div className="w-full max-w-md">
            ...
            <div className="login-form-el">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-0 py-3 pr-10 bg-transparent border-0 border-b border-white/10 text-white text-lg placeholder-white/15 focus:outline-none focus:border-b-2 transition-all"
                ...
                <button
                  ...
                  className="absolute right-0 top-1/2 -translate-y-1/2 p-2 text-white/30 hover:text-white/60 transition-colors"
                >
                  {showPassword ? (
          ...
          <div className="login-form-el grid grid-cols-2 gap-3">
            <button onClick={loginWithGitHub} className="flex items-center justify-center gap-2 px-4 py-3.5 bg-white/3 border border-white/ text-white/50 hover:text-white hover:bg-white/6 transition-all text-sm uppercase tracking-wider font-medium">
            ...
            <button onClick={loginWithGoogle} className="flex items-center justify-center gap-2 px-4 py-3.5 bg-white/3 border border-white/ text-white/50 hover:text-white hover:bg-white/6 transition-all text-sm uppercase tracking-wider font-medium">
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor">
